...
public class HomeActivity extends AppCompatActivity
    ...
    FirebaseRecyclerAdapter<Categories,MenuViewHolder> adapter;
...
//        Load Menu
    ...
    private void loadMenu(){
        adapter = new FirebaseRecyclerAdapter<Categories, MenuViewHolder>(Categories.class,R.layout.menu_item_activity,MenuViewHolder.class,category) {
            @Override
            protected void populateViewHolder(MenuViewHolder viewHolder, Categories model, final int position) {
